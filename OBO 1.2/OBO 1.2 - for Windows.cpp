...
void baslangic(){
	system("cls"); 	// eğer dosya konsoldan açıldıysa konsolla alakalı yazıların ekrandan silinmeisini sağlar.
		...
		while(true){
			...
			if (tus == 'd' || tus == 'D'){
				...
				if (adim > 0){ // eğer sağa gittiysek
					...
					continue; 			// ...o zaman hiçbir şey yapmıyoruz ve while döngüsünün başına dönüyoruz.
